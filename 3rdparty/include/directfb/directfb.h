...
/*
 * Interface to different display outputs, encoders, connector settings, power management and synchronization. <b>Sigma extensions:</b> encoder and output parameters for HD media support
 */
...
/*
 * Deinterlacing modes. <b>Sigma extension</b>
 */
typedef enum {
	 DDM_NONE				= 0x00000000,	/* no deinterlacing, bob single field (scale up to frame size) */
     DDM_WEAVE				= 0x00000001,	/* weave deinterlacing, (assemble two fields to one frame) */
     DDM_ADAPTIVE			= 0x00000002,	/* weave with motion adaptive fallback to bob */
     DDM_IVTC				= 0x00000004,	/* autodetect 3:2 pulldown content and display the original progressive frames. May cause combing artefacts in interlaced areas edited on top of the original content */
     DDM_PROGRESSIVE		= 0x00000008,	/* progressive deinterlacing (force 24/25fps conversion to 50/60fps using 2:3 or 2:2 pulldown) */
} DFBDeinterlacingMode;
...
typedef enum {
     ...
     DLCAPS_COLOR_SPACE       = 0x01000000,  /* Selection of color space is supported. <b>Sigma extension</b> */
     ...
     DLCAPS_ASPECT_MATCHING   = 0x00800000,  /* Supports aspect ratio matching. <b>Sigma extension</b> */

     DLCAPS_ALL               = 0x00F3FFFF
...
/*
 * Flicker filtering modes <b>Sigma extension</b>
 */
typedef enum {
	DLFF_OFF = 0,
	DLFF_LOW,
...
typedef enum {
	...
	/** 16 bit YUV (4 byte/2 pixel, macropixel contains YCbYCr [31:0]) */
	DSPF_I422      = DSPF_UYVY,	//DFB_SURFACE_PIXELFORMAT( 20, 16, 0, 0, 0, 2, 0, 0, 0, 0, 0 ),
...
typedef enum {
     ...
     DCAF_COLOR_SPACE  = 0x00000010,  /* color_space field is valid <b>Sigma extension</b> */
	DCAF_ALL = 0x1F
} DFBColorAdjustmentFlags;

/*
 * Color spaces. <b>Sigma extension</b>
 */
typedef enum {
     DCS_UNKNOWN,		/* unknown color space */
     DCS_RGB,			/* RGB full range */
     DCS_RGB_16_235,	/* RGB limited range */
     DCS_YUV_601,		/* Rec. 601 */
     DCS_YUV_709,		/* ITU-709 */
} DFBColorSpace;
...
typedef struct {
     ...
     u16                    hue;
     u16                    saturation;
     DFBColorSpace            color_space;  /* color space <b>Sigma extension</b> */
} DFBColorAdjustment;
...
/*
 * Aspect ratio matching mode. <b>Sigma extension</b>
 */
typedef enum {
	DARM_NOT_SET    = 0x00000000,  /* has not been set, DARM needs to be determined automatically */
	DARM_AUTO       = 0x00000001,  /* Automatically select the best AR value based on the capabilities of connected output devices */
	DARM_LETTER_BOX = 0x00000002,  /* Display is 4:3, letterbox 16:9 content */
	DARM_PAN_SCAN   = 0x00000004,  /* Display is 4:3, pan scan 16:9 content */
	DARM_SIDE_PANEL = 0x00000008,  /* Display is 16:9, side panel 4:3 content */
	DARM_CROP       = 0x00000010,  /* Display is 16:9, crop top and bottom of 4:3 content (letterbox removal) */
	DARM_ZOOM       = 0x00000020,  /* Display is 4:3, show center of 16:9 content */
	DARM_PANORAMA   = 0x00000040,  /* Display is 16:9, nonlinear stretch of 4:3 content */
	DARM_NONE       = 0x00000080,  /* No matching, pass through the source as is */
} DFBAspectRatioMatch;
...
typedef enum {
	 ...
	 DLCONF_FLICKER_FILTER     = 0x00000080,		// <b>Sigma extension </b>
	 DLCONF_DEINTERLACING_MODE = 0x00000100,		// <b>Sigma extension </b>
     DLCONF_ASPECT_MATCHING    = 0x00000200,		// <b>Sigma extension </b>

     DLCONF_ALL                = 0x000003FF
...
typedef struct {
	 ...
	 // Sigma extensions
	 DFBDisplayLayerFlickerFilter  flicker_filter;	/* Flicker filtering mode <b>Sigma extension </b> */
	 DFBDeinterlacingMode          deint_mode;		/* Deinterlacing mode <b>Sigma extension </b> */
	 DFBAspectRatioMatch           aspect_match;	/* Aspect ratio matching mode <b>Sigma extension </b> */
...
typedef enum {
     ...
     DSOC_DVI            = 0x00000010, /* DVI connector <b>Sigma extension</b> */
     DSOC_HDMI           = 0x00000020, /* HDMI connector */
     DSOC_COMPONENT      = 0x00000040, /* Component video connector */
     DSOC_YCrCb          = DSOC_COMPONENT, /* Component connector <b>Sigma extension</b> */
     DSOC_SCART2         = 0x00000080, /* 2nd SCART connector */
...
typedef enum {
    ...
    /** Sigma extensions, mutualy exclusive with the signals above, which are really connectors **/

    DSOS_NTSC           = 0x00000080, /* NTSC <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */
    DSOS_NTSC_J         = 0x00000100, /* NTSC Japan <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */

    DSOS_PAL            = 0x00000200, /* PAL BG <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */
    DSOS_PAL_M          = 0x00000400, /* PAL M <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */
    DSOS_PAL_60         = 0x00000800, /* PAL 60 <b>Sigma extension; if set with any DSOS_720p to DSOS_EDID signal it means HD-SD conversion</b> */

    DSOS_SDTV           = 0x00001000, /* SDTV 480I/576I signal <b>Sigma extension</b> */
    DSOS_EDTV           = 0x00002000, /* EDTV 480P/576P signal <b>Sigma extension</b> */
    DSOS_720p           = 0x00004000, /* HDTV 720P signal <b>Sigma extension</b> */
    DSOS_1080i          = 0x00008000, /* HDTV 1080I signal <b>Sigma extension</b> */
    DSOS_1080p24		= 0x00010000, /* HDTV 1080P24 (cinema source direct) signal <b>Sigma extension</b> */
    DSOS_1080p          = 0x00020000, /* HDTV 1080P (60/50) signal <b>Sigma extension</b> */
    DSOS_EDID           = 0x00040000, /* signal selected by HDMI EDID <b>Sigma extension</b> */

    DSOS_640x480        = 0x00080000, /* VESA/CVT 640x480 signal <b>Sigma extension</b> */
    DSOS_800x600        = 0x00100000, /* VESA/CVT 800x600 signal <b>Sigma extension</b> */
    DSOS_1024x768       = 0x00200000, /* VESA/CVT 1024x768 signal <b>Sigma extension</b> */
    DSOS_1280x1024      = 0x00400000, /* VESA/CVT 1280x1024 signal <b>Sigma extension</b> */
    DSOS_1600x1200      = 0x00800000, /* VESA/CVT 1600x1200 signal <b>Sigma extension</b> */

    DSOS_1152x864       = 0x01000000, /* VESA/CVT 1152x864 signal <b>Sigma extension</b> */
    DSOS_1280x960       = 0x02000000, /* VESA/CVT 1280x960 signal <b>Sigma extension</b> */
    DSOS_1400x1050      = 0x04000000, /* VESA/CVT 1400x1050 signal <b>Sigma extension</b> */
...
typedef enum {
	 ...
	 DSOCONF_DELAYED_CONFIG			= 0x80000000, /* Specify whether to configure now or later. <Sigma extension> */

     DSOCONF_ALL					= 0x8000000F
...
typedef struct {
	 ...
	 u8						 	 delayed_config; /* If true, don't apply the config now. <b>Sigma extension</b>*/
...
typedef enum {
     ...
     DSECAPS_COLOR_SPACE  = 0x00004000, /* Color spaces can be selected. <b>Sigma extension</b> */
     DSECAPS_ASPECT_MATCH = 0x00008000, /* Aspect ratio match mode can be selected. <b>Sigma extension</b> */
	 DSECAPS_DEINTERLACING_MODE = 0x00010000, /* Deinterlacing mode can be selected. <b>Sigma extension</b> */

     DSECAPS_ALL          = 0x0001ff1f
...
typedef enum {
     ...
     DSET_DTV             = 0x00000003, /* Digital TV encoder. <b>Sigma extension</b> */
...
typedef enum {
     ...
     DSETV_HDTV60         = 0x00000010, /* HDTV 60Hz <b>Sigma extension</b> */
     DSETV_HDTV50         = 0x00000020, /* HDTV 50Hz <b>Sigma extension</b> */
     DSETV_VESA           = 0x00000040, /* VESA <b>Sigma extension</b> */
     DSETV_CVT            = 0x00000080, /* CVT <b>Sigma extension</b> */
...
typedef enum {
     ...
     DSECONF_ASPECT_MATCH			= 0x20000000, /* Match aspect ratio between source and display. <b>Sigma extension</b> */
	 DSECONF_DEINTERLACING_MODE		= 0x40000000, /* Specify the deinterlacing mode to use. <b>Sigma extension</b> */
	 DSECONF_DELAYED_CONFIG			= 0x80000000, /* Specify whether to config right away or wait. <b>Sigma extension</b> */

     DSECONF_ALL					= 0xE00003FF
...
//     DFBAspectRatio				   display_aspect;/* Display aspect ratio <b>Sigma extension</b> */
     DFBAspectRatioMatch           aspect_match;  /* Aspect ratio matching mode <b>Sigma extension</b> */
	 DFBDeinterlacingMode          deint_mode;		/* Deinterlacing mode (Adaptive, Constant blend etc. <b>Sigma extension</b> */
	 __u8						   delayed_config;	/* If true, don't apply settings right away. <b>Sigma extension</b>*/
...
DEFINE_INTERFACE(   IDirectFBDataBuffer,
   ...
   /** Media from data **/
      ...
      * <b>Sigma extension:</b> The SMP8634 Image Provider supports only 4:2:2 JPEG JFIF and returns #DFB_VERSIONMISMATCH if a different version of JPEG is submitted.
      */
     DFBResult (*CreateImageProvider) (
          IDirectFBDataBuffer      *thiz,
