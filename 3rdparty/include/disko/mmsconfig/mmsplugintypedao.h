...
class MMSPluginTypeDAO {
    ...
    public:
        MMSPluginTypeDAO(IMMSDB *connection);
        MMSPluginTypeData *findTypeByName(string name);
        vector<MMSPluginTypeData *> findAllTypes();
};

#endif /*MMSPLUGINTYPEDAO_H_*/
