...
class MMSImportSourceService {
    ...
    public:
        ...
        vector<MMSImportSourceData *> getImportSourcesByPlugin(MMSPluginData *plugin);
        MMSImportSourceData * getImportSourcesByID(int id);
        MMSImportSourceData * getImportSourcesByName(string name);
};

#endif /*MMSIMPORTSOURCESERVICE_H_*/
