...
typedef DFBResult (*dfb_custom_allocate)(SurfaceBuffer *buffer);
typedef DFBResult (*dfb_custom_deallocate)(SurfaceBuffer *buffer);

void dfb_surfacemanager_set_alloc_funcs(SurfaceManager *manager,
    dfb_custom_allocate alloc,
    dfb_custom_deallocate dealloc);
