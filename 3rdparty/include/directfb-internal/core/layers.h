...
struct __DFB_CoreLayerRegionConfig {
	 ...
	 DFBDisplayLayerFlickerFilter flicker_filter;	// <b>Sigma extension</b>
	 DFBDeinterlacingMode deint_mode;				// <b>Sigma extension</b>
	 DFBAspectRatioMatch aspect_match;				// <b>Sigma extension</b>
};
...
typedef enum {
     ...
     CLRCF_FLICKER_FILTER     = 0x01000000,	 // <b>Sigma extension</b>
     CLRCF_DEINTERLACING_MODE = 0x02000000,	 // <b>Sigma extension</b>
     CLRCF_ASPECT_MATCHING    = 0x04000000,	 // <b>Sigma extension</b>

     CLRCF_SURFACE            = 0x10000000,
     CLRCF_PALETTE            = 0x20000000,

     CLRCF_ALL                = 0x3713337F
